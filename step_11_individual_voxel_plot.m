...
if sig.experimental == 1 & sig.old == 1;
    legend(strcat('young exp - diff from old exp: ',num2str(amplitudes(5))),strcat('old exp - diff from old control: ',num2str(amplitudes(8))));
elseif sig.experimental == 1 & sig.old == 0;
    legend(strcat('young exp - diff from old exp: ',num2str(amplitudes(5))),'old exp');
elseif sig.experimental == 0 & sig.old == 1;
    legend('young exp',strcat('old exp - diff from old control: ',num2str(amplitudes(8))));
...
if sig.young == 1 & sig.control == 1;
    legend(strcat('young con - diff from young exp: ',num2str(amplitudes(6))),strcat('old con - diff from young con: ',num2str(amplitudes(7))));
elseif sig.young == 1 & sig.control == 0;
    legend(strcat('young con - diff from young exp: ',num2str(amplitudes(6))),'old con');
elseif sig.young == 0 & sig.control == 1;
    legend('young con',strcat('old con - diff from young con: ',num2str(amplitudes(7))));
...
if sig.Pexperimental == 1 & sig.Pold == 1;
    legend(strcat('young exp - diff from old exp: ',num2str(amplitudesP(5))),strcat('old exp - diff from old control: ',num2str(amplitudesP(8))));
elseif sig.Pexperimental == 1 & sig.Pold == 0;
    legend(strcat('young exp - diff from old exp: ',num2str(amplitudesP(5))),'old exp');
elseif sig.Pexperimental == 0 & sig.Pold == 1;
    legend('young exp',strcat('old exp - diff from old control: ',num2str(amplitudesP(8))));
...
if sig.Pyoung == 1 & sig.Pcontrol == 1;
    legend(strcat('young con - diff from young exp: ',num2str(amplitudesP(6))),strcat('old con - diff from young con: ',num2str(amplitudesP(7))));
elseif sig.Pyoung == 1 & sig.Pcontrol == 0;
    legend(strcat('young con - diff from young exp: ',num2str(amplitudesP(6))),'old con');
elseif sig.Pyoung == 0 & sig.Pcontrol == 1;
    legend('young con',strcat('old con - diff from young con: ',num2str(amplitudesP(7))));
...
if cov_sig.experimental == 1 & cov_sig.old == 1;
    legend(strcat('young exp - diff from old exp: ',num2str(cov_amplitudes(5))),strcat('old exp - diff from old control: ',num2str(cov_amplitudes(8))));
elseif cov_sig.experimental == 1 & cov_sig.old == 0;
    legend(strcat('young exp - diff from old exp: ',num2str(cov_amplitudes(5))),'old exp');
elseif cov_sig.experimental == 0 & cov_sig.old == 1;
    legend('young exp',strcat('old exp - diff from old control: ',num2str(cov_amplitudes(8))));
...
if cov_sig.young == 1 & cov_sig.control == 1;
    legend(strcat('young con - diff from young exp: ',num2str(cov_amplitudes(6))),strcat('old con - diff from young con: ',num2str(cov_amplitudes(7))));
elseif cov_sig.young == 1 & cov_sig.control == 0;
    legend(strcat('young con - diff from young exp: ',num2str(cov_amplitudes(6))),'old con');
elseif cov_sig.young == 0 & cov_sig.control == 1;
    legend('young con',strcat('old con - diff from young con: ',num2str(cov_amplitudes(7))));
...
if cov_sig.Pexperimental == 1 & cov_sig.Pold == 1;
    legend(strcat('young exp - diff from old exp: ',num2str(cov_amplitudesP(5))),strcat('old exp - diff from old control: ',num2str(cov_amplitudesP(8))));
elseif cov_sig.Pexperimental == 1 & cov_sig.Pold == 0;
    legend(strcat('young exp - diff from old exp: ',num2str(cov_amplitudesP(5))),'old exp');
elseif cov_sig.Pexperimental == 0 & cov_sig.Pold == 1;
    legend('young exp',strcat('old exp - diff from old control: ',num2str(cov_amplitudesP(8))));
...
if cov_sig.Pyoung == 1 & cov_sig.cov_pcontrol == 1;
    legend(strcat('young con - diff from young exp: ',num2str(cov_amplitudesP(6))),strcat('old con - diff from young con: ',num2str(cov_amplitudesP(7))));
elseif cov_sig.Pyoung == 1 & cov_sig.cov_pcontrol == 0;
    legend(strcat('young con - diff from young exp: ',num2str(cov_amplitudesP(6))),'old con');
elseif cov_sig.Pyoung == 0 & cov_sig.cov_pcontrol == 1;
    legend('young con',strcat('old con - diff from young con: ',num2str(cov_amplitudesP(7))));
